...
export async function getBestPool() {
    ...
    const completion = await openai.chat.completions.create({
      messages: [{ role: 'system', content: "You are an expert in Decentralized Finance and a statistical computer for investment returns. Your goal is to find the highest interest rate pool for my money. You must return me only one word, which is the name of the pool. I will give you a map from each pool name to the last 20 daily APYs of the pool."}, 
